    ...
    do
		...
		echo
            ...
            then
                ...
                echo $brcFuncInput
                curl http://localhost:8101 -H "Content-Type: application/json" -X POST --data '{"jsonrpc":"2.0","method":"eth_sendTransaction","params":[{"from":"'$aliceAddress'","to":"'$contractAddress'","data":"'$brcFuncInput'"}],"id":1021}'
